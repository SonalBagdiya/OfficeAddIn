...
<body>
    ...
    <div class="panel panel-default">
        <div class="panel-heading modes mode-list" style="display:block">
           sdasdsada <img alt="Brand" src="../../Images/odata_logo.png" />
        </div>
        <div class="loading" style="display:none">Loading...</div>
        <div class="panel-body loaded non-expandtable-area">
            <div id="list-page" class="modes mode-list" style="display: block">
